        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('sellerProduct.update', [$seller->id, $ProductSeller->id]) }}" method="post" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
                            @if($product)
                            <div class="col-md-6">
                            ...
                            <div class="properties row col-md-12">
                                ...
                                @if($product->category)
                                    @foreach($product->category->properties as $key => $property)
                                        <div class="col-md-6">
                                            <label for="property_title" class="form-label">{{ $property->name }}</label>
                                            @if(isset($product->properties[$key]))
                                                <input type="hidden" name="old_property_id[]" value="{{ $product->properties[$key]->id }}">
                                            @endif
                                            <input type="hidden" name="property_id[]" value="{{ $property->id }}">
                                            <input type="text" name="property_value[]" class="form-control" @if(isset($product->properties[$key])) value="{{ $product->properties[$key]->value }}" @endif>
                                        </div>
                                    @endforeach
                                @endif
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="price" class="form-control" id="price" required value="{{ $ProductSeller->price }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="off" class="form-control" id="off" value="{{ $ProductSeller->off }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="stock" class="form-control" id="stock" required value="{{ $ProductSeller->stock?$ProductSeller->stock:'0' }}">
                                <div class="invalid-feedback">لطفا موجودی محصول را وارد کنید</div>
                            </div>
                            <div class="col-md-6">
                                <label for="warranty" class="form-label">نوع گارانتی</label>
                                <input type="text" name="warranty" class="form-control" id="warranty" value="{{ $ProductSeller->warranty }}" placeholder="گارانتی اصالت و سلامت کالا">
